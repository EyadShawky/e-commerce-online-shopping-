        ...
        <form action="{{url('/admin/products')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group w-75 mb-3">
                ...
                <div class="form-check form-check-inline ml-3">
                    <input class="form-check-input" type="radio" name="categories_id" value="1" >
                    <label class="form-check-label" for="inlineRadio1">Hoodies</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="categories_id" value="2" >
